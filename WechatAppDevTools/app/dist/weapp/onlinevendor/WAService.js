! function(e) {
    if (!e.WeixinJSBridge) {
        ...
        var p = function(t, n, i) {
            ...
            f = function(t, n, r) { o ? e.webkit.messageHandlers.publishHandler.postMessage({ event: t, paramsString: n, webviewIds: r }) : WeixinJSCore.publishHandler(t, n, r) },
            l = function(e, t, n) {
...
var Reporter = function(e) {
        ...
        function o(e) { "undefined" != typeof WeixinJSBridge ? e() : document.addEventListener("WeixinJSBridgeReady", e, !1) }

        function r() {
            var e = arguments;
            o(function() { WeixinJSBridge.invoke.apply(WeixinJSBridge, e) })
        }

        function i() {!h || h.length <= 0 || (r("reportKeyValue", { dataArray: h }), h = []) }

        function a() {!g || g.length <= 0 || (r("reportIDKey", { dataArray: g }), g = []) }

        function u() {!v || v.length <= 0 || (r("systemLog", { dataArray: v }), v = []) }
        ...
        r("getPublicLibVersion", {}, function(e) {
            try { y = e.version.appVersion + " " + e.version.libVersion } catch (e) {}
        });
        var T = {
                speedReport: function(e) {
                    ...
                    if (!(Date.now() - _ < b)) {
                        var r = 0,
                            i = 0;
                        1 != t && 2 != t || (r = JSON.stringify(n || {}).length, i = o.nativeTime || 0), T.reportKeyValue({ key: "Speed", value: t + "," + o.startTime + "," + i + "," + i + "," + o.endTime + "," + r })
                    }
                },
                reportKeyValue: function(e) {
                    var t = e.key,
                        n = e.value;
                    p.KeyValueType[t] && (Date.now() - _ < b || (_ = Date.now(), h.push({ key: p.KeyValueType[t], value: n }), h.length >= l && i()))
                },
                reportIDKey: function(e) {
                    var t = e.id,
                        n = e.key;
                    p.IDKeyType[n] && (Date.now() - k < m || (k = Date.now(), g.push({ id: t ? t : "356", key: p.IDKeyType[n], value: 1 }), g.length >= f && a()))
                },
                errorReport: function(e) {
                    var t = e.key,
                        n = e.error;
                    p.ErrorType[t] && (T.reportIDKey({ key: t }), T.reportKeyValue({ key: "Error", value: p.ErrorType[t] + "," + n.name + "," + encodeURIComponent(n.message) + "," + encodeURIComponent(n.stack) + "," + encodeURIComponent(y) }), a(), i(), u())
                },
                log: function(e) { e && "string" == typeof e && (Date.now() - A < S || (A = Date.now(), v.push(e + ""), v.length >= d && u())) },
                submit: function() { Date.now() - P < w || (P = Date.now(), a(), i(), u()) }
            },
            O = {};
        for (var M in T) s(M);
        "undefined" != typeof window && (window.onbeforeunload = function() { T.submit() }), e.exports = O
    }, function(e, t) {
        "use strict";
    ...
    wx = function(e) {
        ...
        function r(e) {
            if ("[object Error]" === Object.prototype.toString.apply(e)) {
                ...
                S ? console.error(e.stack) : console.error(e.message), Reporter.errorReport({ key: "appServiceSDKScriptError", error: e })
            }
        }
        ...
        "devtools" === (0, p.getPlatform)() && (0, s.subscribe)("SPECIAL_PAGE_EVENT", function(e) {
            ...
            if (t && "input" == t.type && "function" == typeof b) {
                ...
                "String" === (0, p.getDataType)(r) ? r != t.detail.value && (0, s.publish)("setKeyboardValue", { value: r, cursor: -1 }, [o]): "Object" === (0, p.getDataType)(r) && (0, s.publish)("setKeyboardValue", { value: r.value || "", cursor: "undefined" == typeof r.cursor ? -1 : r.cursor }, [o])
            }
        });
        var T = {
            invoke: s.invoke,
            ...
            onPullDownRefresh: function(e) { console.log("onPullDownRefresh has been removed from api list") },
            ...
            redirectTo: function(e) { u("redirectTo", e, { url: "" }) && (e.url = (0, p.getRealRoute)(v, e.url), e.url = (0, p.encodeUrlQuery)(e.url), (0, s.invokeMethod)("redirectTo", e, { afterSuccess: function() { v = e.url } })) },
            navigateTo: function(e) { u("navigateTo", e, { url: "" }) && (e.url = (0, p.getRealRoute)(v, e.url), e.url = (0, p.encodeUrlQuery)(e.url), (0, s.invokeMethod)("navigateTo", e, { afterSuccess: function() { v = e.url, (0, d.notifyCurrentRoutetoContext)(v) } })) },
            navigateBack: function(e) {
                (0, s.invokeMethod)("navigateBack", e)
            },
            getStorage: function(e) { u("getStorage", e, { key: "" }) && (0, s.invokeMethod)("getStorage", e, { beforeSuccess: function(e) { e.data = (0, p.stringToAnyType)(e.data, e.dataType), delete e.dataType } }) },
            ...
            setStorage: function(e) {
                if (u("setStorage", e, { key: "" })) {
                    var t = (0, p.anyTypeToString)(e.data),
                        n = t.data,
                        o = t.dataType;
                    (0, s.invokeMethod)("setStorage", { key: e.key, data: n, dataType: o, success: e.success, fail: e.fail, complete: e.complete })
                }
            },
            ...
            request: function() {
                ...
                if (u("request", e, { url: "" })) {
                    ...
                    i = "string" != typeof e.data ? o["content-type"].indexOf("application/x-www-form-urlencoded") > -1 ? (0, p.urlEncodeFormData)(e.data) : o["content-type"].indexOf("application/json") > -1 ? JSON.stringify(e.data) : "object" === c(e.data) ? JSON.stringify(e.data) : i.toString() : e.data, "GET" === r.toUpperCase() && (e.url = (0, p.addQueryStringToUrl)(e.url, e.data)), (0, s.invokeMethod)("request", { url: e.url, data: i, header: o, method: r, success: e.success, fail: e.fail, complete: e.complete }, {
                        beforeSuccess: function(t) {
                            if ("json" === e.dataType) try { t.data = JSON.parse(t.data) } catch (e) {}
                        }
                    })
                }
            },
            connectSocket: function(e) { u("connectSocket", e, { url: "" }) && (0, s.invokeMethod)("connectSocket", e) },
            closeSocket: function(e) {
                (0, s.invokeMethod)("closeSocket", e)
            },
            sendSocketMessage: function(e) { u("sendSocketMessage", e, { data: "" }) && (0, s.invokeMethod)("sendSocketMessage", e) },
            onSocketOpen: function(e) { u("onSocketOpen", e, function() {}) && (0, s.onMethod)("onSocketOpen", e) },
            onSocketClose: function(e) { u("onSocketClose", e, function() {}) && (0, s.onMethod)("onSocketClose", e) },
            onSocketMessage: function(e) { u("onSocketMessage", e, function() {}) && (0, s.onMethod)("onSocketMessage", e) },
            onSocketError: function(e) { u("onSocketError", e, function() {}) && (0, s.onMethod)("onSocketError", e) },
            uploadFile: function(e) { u("uploadFile", e, { url: "", filePath: "", name: "" }) && (0, s.invokeMethod)("uploadFile", e) },
            downloadFile: function(e) { u("downloadFile", e, { url: "" }) && (0, s.invokeMethod)("downloadFile", e) },
            chooseImage: function() {
                var e = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0];
                (0, s.invokeMethod)("chooseImage", (0, p.assign)({ count: 9, sizeType: ["original", "compressed"], sourceType: ["album", "camera"] }, e), e)
            },
            previewImage: function(e) { u("previewImage", e, { urls: [""] }) && (0, s.invokeMethod)("previewImage", e) },
            ...
            playVoice: function(e) { u("playVoice", e, { filePath: "" }) && (0, s.invokeMethod)("playVoice", e) },
            ...
            onAccelerometerChange: function(e) { _ || ((0, s.invokeMethod)("enableAccelerometer", { enable: !0 }), _ = !0), A.push(e) },
            onCompassChange: function(e) { k || ((0, s.invokeMethod)("enableCompass", { enable: !0 }), k = !0), P.push(e) },
            ...
            playBackgroundAudio: function() {
                var e = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0];
                (0, s.invokeMethod)("operateMusicPlayer", (0, p.assign)({ operationType: "play" }, e), { beforeAll: function(e) { e.errMsg = e.errMsg.replace("operateMusicPlayer", "playBackgroundAudio") } })
            },
            ...
            seekBackgroundAudio: function() {
                var e = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0];
                (0, s.invokeMethod)("operateMusicPlayer", (0, p.assign)({ operationType: "seek" }, e), { beforeAll: function(e) { e.errMsg = e.errMsg.replace("operateMusicPlayer", "seekBackgroundAudio") } })
            },
            stopBackgroundAudio: function() {
                var e = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0];
                (0, s.invokeMethod)("operateMusicPlayer", (0, p.assign)({ operationType: "stop" }, e), { beforeAll: function(e) { e.errMsg = e.errMsg.replace("operateMusicPlayer", "stopBackgroundAudio") } })
            },
            ...
            getUserInfo: function(e) {
                (0, s.invokeMethod)("operateWXData", (0, p.assign)({ data: { api_name: "webapi_getuserinfo", data: e.data || {} } }, e), {
                    beforeAll: function(e) { e.errMsg = e.errMsg.replace("operateWXData", "getUserInfo") },
                    beforeSuccess: function(e) {
                        "android" === (0, p.getPlatform)() && (e.data = JSON.parse(e.data)), e.rawData = e.data.data;
                        try { e.userInfo = JSON.parse(e.data.data), e.signature = e.data.signature, e.encryptData = e.data.encryptData, delete e.data } catch (e) {}
                    }
                })
            },
            getFriends: function(e) {
                (0, s.invokeMethod)("operateWXData", { data: { api_name: "webapi_getfriends", data: e.data || {} }, success: e.success, fail: e.fail, complete: e.complete }, {
                    beforeAll: function(e) { e.errMsg = e.errMsg.replace("operateWXData", "getFriends") },
                    beforeSuccess: function(e) {
                        "android" === (0, p.getPlatform)() && (e.data = JSON.parse(e.data)), e.rawData = e.data.data;
                        try { e.friends = JSON.parse(e.data.data), e.signature = e.data.signature, delete e.data } catch (e) {}
                    }
                })
            },
            ...
            setAppData: function(e) {
                ...
                ! function() {
                    var o = !1,
                        r = {},
                        i = function(e, t, n) { o = !0, r[e] = t, "Array" === n || "Object" === n ? g[e] = JSON.parse(JSON.stringify(t)) : g[e] = t };
                    for (var a in e) {
                        var u = e[a],
                            c = g[a],
                            f = (0, p.getDataType)(c),
                    ...
                    t.forceUpdate ? (0, s.publish)("appDataChange", { data: e, option: { timestamp: Date.now(), forceUpdate: !0 } }, n) : o && (0, s.publish)("appDataChange", { data: r }, n)
                }()
            },
            onPageEvent: function(e, t) { console.warn("'onPageEvent' is deprecated, use 'Page[eventName]'") },
            ...
            onNativeEvent: function(e) {
                ["onCanvasTouchStart", "onCanvasTouchMove", "onCanvasTouchEnd"].forEach(function(t) {
                    (0, s.onMethod)(t, function(n, o) { e({ data: n, eventName: t, webviewId: o }) })
                })
            },
            hideKeyboard: function(e) { "devtools" == (0, p.getPlatform)() ? (0, s.publish)("hideKeyboard", {}) : (0, s.invokeMethod)("hideKeyboard", e) },
            getPublicLibVersion: function() {
                var e = void 0;
                return (0, s.invokeMethod)("getPublicLibVersion", { complete: function(t) { t.version ? e = t.version : (e = t, delete e.errMsg) } }), e
            }
        };
        (0, s.subscribe)("pageReady", function() {
            ...
            "navigateBack" != e.openType && "redirectTo" != e.openType || (0, h.clearOldWebviewCanvas)(), (0, h.notifyWebviewIdtoCanvas)(e.webviewId), y.forEach(function(t) { t(e) })
        })), (0, s.onMethod)("onAppRouteDone", i(function(e) {
            var t = arguments.length <= 1 || void 0 === arguments[1] ? 0 : arguments[1];
            e.path = e.path.substring(0, e.path.length - 5), e.webviewId = "undefined" != typeof e.webviewId ? e.webviewId : t, v = e.path, w.forEach(function(t) { t(e) }), (0, s.publish)("onAppRouteDone", {}, [t])
            ...
            if (e.data && "function" == typeof b) {
                ...
                if (r.bindinput) {
                    var i;
                    try { i = b({ data: { type: "input", target: r.target, currentTarget: r.target, timeStamp: Date.now(), touches: [], detail: { value: e.value, cursor: e.cursor } }, eventName: r.bindinput, webviewId: t }) } catch (e) {
                        throw new p.AppServiceSdkKnownError("bind key input error")
                    }
                    "String" === (0, p.getDataType)(i) ? (o = -1, n = i, (0, s.invokeMethod)("setKeyboardValue", { value: n, cursor: o, inputId: e.inputId })) : "Object" === (0, p.getDataType)(i) && (n = i.value || "", o = "undefined" == typeof i.cursor ? -1 : i.cursor, (0, s.invokeMethod)("setKeyboardValue", { value: n, cursor: o, inputId: e.inputId }))
                }
            }(0, s.publish)("setKeyboardValue", { value: n, cursor: o, inputId: e.inputId }, [t])
        })), (0, s.onMethod)("onAccelerometerChange", i(function() {
            var e = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0];
            arguments.length <= 1 || void 0 === arguments[1] ? 0 : arguments[1];
            A.forEach(function(t) { "function" == typeof t && t(e) })
        })), (0, s.onMethod)("onCompassChange", i(function() {
            var e = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0];
            arguments.length <= 1 || void 0 === arguments[1] ? 0 : arguments[1];
            P.forEach(function(t) { "function" == typeof t && t(e) })
        }));
        for (var O in T) a(O);
        e.exports = m
    }, function(e, t) {
        function n() { WeixinJSBridge.invoke.apply(WeixinJSBridge, arguments) }

        function o() { WeixinJSBridge.on.apply(WeixinJSBridge, arguments) }
        ...
        function i() {
            ...
            e[1] = function(e, n) {
                var o = e.data,
                    ...
                    a = r && r.timestamp || 0,
                    u = Date.now();
                "function" == typeof t && t(o, n), Reporter.speedReport({ direction: 1, data: o || {}, timeMark: { startTime: a, endTime: u, nativeTime: i.nativeTime || 0 } })
        ...
        function i(e) {
            ...
            return e = "Array" == t || "Object" == t ? JSON.stringify(e) : "String" == t || "Number" == t || "Boolean" == t ? e.toString() : "Date" == t ? e.getTime().toString() : "Undefined" == t ? "undefined" : "Null" == t ? "null" : "", { data: e, dataType: t }
        }
        ...
        var r = function() {
            ...
            i = function() {
                function e() {
                    ...
                    o(this, e), this.actions = [], this.currentTransform = [], this.currentStepAnimates = [], this.option = { transition: { duration: "undefined" != typeof t.duration ? t.duration : 400, timingFunction: "undefined" != typeof t.timingFunction ? t.timingFunction : "linear", delay: "undefined" != typeof t.delay ? t.delay : 0 }, transformOrigin: t.transformOrigin || "50% 50% 0" }
                }
                return r(e, [{
                    key: "export",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        return this.currentStepAnimates.push({ type: "matrix3d", args: [e, t, n, o, r, i, a, u, c, s, p, f, l, d, h, g] }), this.stepping = !1, this
                    }
                }, {
                    key: "rotate",
                    value: function() {
                    ...
                    value: function() {
                        var e = arguments.length <= 0 || void 0 === arguments[0] ? 1 : arguments[0],
                            t = arguments[1];
                        return t = "undefined" != typeof t ? t : e, this.currentStepAnimates.push({ type: "scale", args: [e, t] }), this
                    }
                }, {
                    key: "scale3d",
                    value: function() {
                    ...
                    key: "width",
                    value: function(e) {
                        return "number" == typeof e && (e += "px"), this.currentStepAnimates.push({ type: "style", args: ["width", e] }), this
                    }
                }, {
                    key: "height",
                    value: function(e) {
                        return "number" == typeof e && (e += "px"), this.currentStepAnimates.push({ type: "style", args: ["height", e] }), this
                    }
                }, {
                    key: "left",
                    value: function(e) {
                        return "number" == typeof e && (e += "px"), this.currentStepAnimates.push({ type: "style", args: ["left", e] }), this
                    }
                }, {
                    key: "right",
                    value: function(e) {
                        return "number" == typeof e && (e += "px"), this.currentStepAnimates.push({ type: "style", args: ["right", e] }), this
                    }
                }, {
                    key: "top",
                    value: function(e) {
                        return "number" == typeof e && (e += "px"), this.currentStepAnimates.push({ type: "style", args: ["top", e] }), this
                    }
                }, {
                    key: "bottom",
                    value: function(e) {
                        return "number" == typeof e && (e += "px"), this.currentStepAnimates.push({ type: "style", args: ["bottom", e] }), this
                    }
                }]), e
            }();
        t.default = i
    }, function(module, exports) {
        if (!("undefined" != typeof navigator && navigator.userAgent && navigator.userAgent.indexOf("appservice") > -1)) try { eval("const GeneratorFunction = Object.getPrototypeOf(function *() {}).constructor; const f = new GeneratorFunction('', 'console.log(0)'); f().__proto__.__proto__.next = () => {};") } catch (e) {}
    }, function(e, t, n) {
        (function(e) {
            n(1);
        ...
        function a(e, t) { this.type = e, this.data = t, this.colorStop = [] }

        function u() { this.actions = [], this.path = [] }

        function c(e) {
            if (Array.isArray(e)) {
                var t = [];
                return e.forEach(function(e) { t.push(c(e)) }), t
            }
        ...
        var s = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            ...
            g = "";
        a.prototype.addColorStop = function(e, t) { this.colorStop.push([e, i(t)]) }, u.prototype.getActions = function() {
            var e = c(this.actions);
            return this.actions = [], this.path = [], e
        }, u.prototype.clearActions = function() { this.actions = [], this.path = [] }, [].concat(f, l).forEach(function(e) { "fill" == e || "stroke" == e ? u.prototype[e] = function() { this.actions.push({ method: e + "Path", data: c(this.path) }) } : "fillText" == e ? u.prototype[e] = function(t, n, o) { this.actions.push({ method: e, data: [t.toString(), n, o] }) } : "drawImage" == e ? u.prototype[e] = function(t, n, o, i, a) { "devtools" == (0, p.getPlatform)() || /wxfile:\/\//.test(t) || (t = (0, p.getRealRoute)(g, t).replace(/.html$/, "")), r(i) && r(a) ? data = [t, n, o, i, a] : data = [t, n, o], this.actions.push({ method: e, data: data }) } : u.prototype[e] = function() { this.actions.push({ method: e, data: [].slice.apply(arguments) }) } }), d.forEach(function(e) { "beginPath" == e ? u.prototype[e] = function() { this.path = [] } : "lineTo" == e ? u.prototype.lineTo = function() { 0 == this.path.length ? this.path.push({ method: "moveTo", data: [].slice.apply(arguments) }) : this.path.push({ method: "lineTo", data: [].slice.apply(arguments) }) } : u.prototype[e] = function() { this.path.push({ method: e, data: [].slice.apply(arguments) }) } }), h.forEach(function(e) {
            "createLinearGradient" == e ? u.prototype[e] = function() {
                ...
                var t = arguments[0];
                "string" == typeof t ? this.actions.push({ method: e, data: ["normal", i(t)] }) : "object" == ("undefined" == typeof t ? "undefined" : s(t)) && t instanceof a && this.actions.push({ method: e, data: [t.type, t.data, t.colorStop] })
                ...
                t[3] = i(t[3]), this.actions.push({ method: e, data: t })
            } : u.prototype[e] = function() { this.actions.push({ method: e, data: [].slice.apply(arguments, [0, 1]) }) }
        ...
        function a(e, t) {
            var n = !(arguments.length <= 2 || void 0 === arguments[2]) && arguments[2],
                ...
                i = arguments[5],
                a = (0, l.getPlatform)();
            "ios" == a || "android" == a ? WeixinJSBridge.invoke("drawCanvas", { canvasId: e, reserve: n, actions: t }, function(e) { e.errMsg && /ok/.test(e.errMsg) ? "function" == typeof o && o(e) : "function" == typeof r && r(e), "function" == typeof i && i(e) }) : WeixinJSBridge.publish("canvas" + e + "actionsChanged", { actions: t, reserve: n })
        }
        ...
        function u(e) {
            ...
            if (t && Array.isArray(n)) {
                ...
                if ("number" == typeof h[s]) {
                    var p = h[s];
                    a(p, n, r, i, u, c)
                } else g[s] = g[s] || [], g[s] = g[s].concat({ actions: n, reserve: r, success: i, fail: u, complete: c })
            }
        }
        ...
        function c(e) {
            if (e.canvasId) {
                ...
                if ("number" == typeof h[t]) e.canvasId = h[t], (0, p.invokeMethod)("toTempFilePath", e);
                    ...
                    var n = { errMsg: "toTempFilePath: fail canvas is empty" };
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }), t.createContext = t.toTempFilePath = t.drawCanvas = t.notifyWebviewIdtoCanvas = t.clearOldWebviewCanvas = void 0;
        var p = n(1),
            f = n(8),
            l = n(2),
            d = 0,
        ...
        WeixinJSBridge.subscribe("canvasInsert", function(e, t) {
            var n = e.canvasId,
                r = e.canvasNumber,
                i = o(d, n);
            h[i] = h[i] || r, Array.isArray(g[i]) && (g[i].forEach(function(e) { a(r, e.actions, e.success, e.fail, e.complete) }), delete g[i])
    ...
    __appServiceEngine = function(e) {
        ...
        var r = n(2),
            ...
            f = {},
            l = 0,
            d = { appRouteTime: 0, newPageTime: 0, pageReadyTime: 0 },
            h = function(e, t, n) {
                var o = c.SPEED_REPORT_TYPE[e];
                o && (Reporter.reportKeyValue({ key: "Speed", value: o + "," + t + ",0,0," + n }), Reporter.log("JSEngine SpeedReport:" + e + ",startTime:" + t + ",endTime:" + n + ",cost:" + (n - t)))
            },
            g = (t.getCurrentPage = function() {
                ...
                (0, u.isDevTools)() && (__wxAppData[e] = r.data, __wxAppData[e].__webviewId__ = t, (0, u.publish)(c.UPDATE_APP_DATA)), s = { page: r, webviewId: t, route: e }, r.onLoad(n), r.onShow(), p[t] = { page: r, route: e }, h("appRoute2newPage", d.appRouteTime, d.newPageTime)
            }),
            v = function(e) { e.page.onHide() },
            y = function(e) { e.page.onUnload(), (0, u.isDevTools)() && (delete __wxAppData[e.route], (0, u.publish)(c.UPDATE_APP_DATA)), delete p[e.webviewId] },
            w = function(e, t, n, o) {
        ...
        wx.onAppRoute((0, u.surroundByTryCatch)(function(e) {
            ...
            var t = e.webviewId,
                ...
                o = e.data;
            return m(t, n, o)
        })), WeixinJSBridge.on("onPullDownRefresh", (0, u.surroundByTryCatch)(function(e, t) { S(t) })), WeixinJSBridge.on("onMenuShareAppMessage", (0, u.surroundByTryCatch)(function(e, t) {
            var n = _(e, t);
            ...
            var n = p[t].page,
                o = {};
            (0, u.info)("Update view with init data"), o.webviewId = t, __wxConfig && __wxConfig.downloadDomain && (o.downloadDomain = __wxConfig.downloadDomain), (0, u.publish)("pageInitData", { data: { data: n.data, ext: o, options: { type: "data", firstRender: !0 } } }, [t]), n.__webviewReady__ = !0, (0, u.isEmptyObject)(n.__waitingData__) || ((0, u.info)("Update view with waiting data"), (0, u.info)(n.__waitingData__), (0, u.publish)("appDataChange", { data: { data: n.__waitingData__, options: { type: "data" } } }, [t]), n.__waitingData__ = {}), (0, u.isEmptyObject)(n.__waitingAction__) || ((0, u.info)("Update view with waiting action"), (0, u.info)(n.__waitingAction__), (0, u.publish)("appDataChange", { data: { data: n.__waitingAction__, options: { type: "action" } } }, [t]), n.__waitingAction__ = {})
        }));
        t.reset = function() { s = void 0, p = {}, f = {}, l = 0 }, t.setWxConfig = function(e) { __wxConfig = e }, t.setWxRoute = function(e) { __wxRoute = e }, t.setWxRouteBegin = function(e) { __wxRouteBegin = e }, t.getWebviewIdToPage = function() {
            return p
        ...
        var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            ...
            c = (t.hasOwn = function(e, t) {
                return u.call(e, t)
            }, t.def = function(e, t, n, o) { Object.defineProperty(e, t, { value: n, enumerable: !!o, writable: !0, configurable: !0 }) }, Object.prototype.toString),
            s = "[object Object]",
            p = (t.isPlainObject = function(e) {
                return c.call(e) === s
            }, t.error = function(e, t) { console.group("%c" + e, "color: red; font-size: x-large"), console.error("%c" + t, "color: red; font-size: x-large"), console.groupEnd() }, t.warn = function(e) { __wxConfig && __wxConfig.debug && console.warn(e) }, t.info = function(e) { __wxConfig && __wxConfig.debug && console.info(e) }, t.surroundByTryCatch = function(e) {
                return function() {
                    try {
                        return e.apply(e, arguments)
                    } catch (e) {
        ...
        var i = function() {
            ...
            h = function() {
                function e() {
                    ...
                    r(this, e), this.__wxWebviewId__ = o, this.__route__ = i, this.__webviewReady__ = !1, this.__waitingData__ = {}, this.__waitingAction__ = {}, this.data = JSON.parse(JSON.stringify(t.data || {})), p.forEach(function(e) {
                        n[e] = function() {
                            ...
                            try { n.apply(this, arguments) } catch (e) { console.error(e.stack), Reporter.errorReport({ key: "thirdScriptError", error: e }) }
                        }.bind(n)
                    });
                    var u = function(e) {
                        d(e) ? (0, a.warn)("Page's " + e + " is write-protected") : f(e) || ("[object Function]" === Object.prototype.toString.call(t[e]) ? n[e] = function() {
                            var n;
                            try { n = t[e].apply(this, arguments) } catch (e) { console.error(e.stack), Reporter.errorReport({ key: "thirdScriptError", error: e }) }
                            return n
                ...
                return i(e, [{
                    ...
                    key: "setAction",
                    value: function(e) {
                        try { this.__webviewReady__ ? s.default.emit(e, "action", this.__wxWebviewId__) : (0, a.extend)(this.__waitingAction__, e) } catch (e) {
                            (0, a.errorReport)(e)
                        }
                    }
                }]), e
            ...
            a = function() {
                ...
                return r(e, null, [{
                    ...
                    value: function(e, t, n) {
                        (0, i.info)("Update view with"), (0, i.info)(e), (0, i.publish)("appDataChange", { data: { data: e, options: { type: t } } }, [n])
                    }
                }]), e
            }();
        t.default = a
        ...
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
        t.DOM_READY_EVENT = "__DOMReady", t.SPEED_REPORT_TYPE = { appRoute2newPage: 8, newPage2pageReady: 9 }, t.UPDATE_APP_DATA = "__updateAppData"
    }, function(e, t, n) {
        "use strict";
        ...
        var r = function() {
            ...
            l = void 0;
        t.appHolder = (0, i.surroundByTryCatch)(function(e) { l = new f(e) }), t.getApp = function() {
            return l
        }
    }]),
...
! function() {
    var e = 1,
        t = 2,
        n = {};
    define = function(t, o) { n[t] = { status: e, factory: o } };
    var o = function(e) {
            var t = e.match(/(.*)\/([^\/]+)?$/);
            return t && t[1] ? t[1] : "./"
        },
