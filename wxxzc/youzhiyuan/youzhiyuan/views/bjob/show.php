...
<script src="http://localhost/sixgroup/web/assets/Jquery/jquery.js"></script>
...
<script src="Admin/js/upd.js"></script>
                                            <div id="map">
                                                <span class='title'>职位分类添加</span>
                                            </div>
                                            <div id="content">
                                                <form id="categoryForm" action="?r=bjob/add" method="post">
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="fid">
                                                                    ...
                                                                    <?php foreach($arr as $key=>$val){?>
                                                                        <option value="<?php echo $val['pid']?>">|--<?php echo $val['html'].$val['fname']?></option>
                                                                    <?php }?>
                                                                </select>
                                                            </td>
                                                        </tr>
