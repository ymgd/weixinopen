...
<div class="login_wrapper">
    ...
    <div class="find_psw">
        ...
        <form id="pswForm" action="index.php?r=flogin/resetpwd" method="post">
            <input name="_csrf" type="hidden" id="_csrf" value="<?= Yii::$app->request->csrfToken ?>">
            <input type="password" name="password" id="password" tabindex="1" value="" placeholder="请输入新密码" />
            <input type="password" name="password" id="password" tabindex="1" value="" placeholder="请再次输入新密码" />
            <input type="submit" id="submitLogin" value="确定" />
        </form>
        <!--<img src="assets/style/images/psw_step1.png" width="369" height="56" alt="找回密码第二步" />
